...
public:
    ...
    static bool AddNewBook(string id, string name, string writer, string publisher,int num);
    static bool AddOldBook(string id,int num);
    static Reader* FindReader(string id);
    static bool AddReader(string id,string name,string psw);
    static bool RemoveReader(string id);
    static Ladmin* FindAdmin(string id);
    static bool RemoveAdmin(string id);
    static bool AddAdmin(string id,string name,string psw);
